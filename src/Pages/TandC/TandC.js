    ...
    return (
        <>
            <div className="TandC">
                ...
                <br />
                <h5>By using Producto Shop, you acknowledge that you have read, understood, and agree to these Terms and Conditions.</h5>
            </div>
        </>
    )
}
