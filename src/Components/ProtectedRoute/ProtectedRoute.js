...
function ProtectedRoute({children}) {  
    ...
    if(!username) {
        return <Navigate to='/Login' replace /> // if there is no username, redirect to the Login page. and also we use replace to prevent the user from going back to the previous page from login.
    }
